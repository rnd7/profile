# About
Welcome fellow. Check out my personal github page. All my spare time work will end up here if it compiles. Time is rare and there is so much stuff to do, so I will likely not accept any Feature Requests. Feel free to send Pull-Requests, but please be patient.
...
# Selected work
In late 2018 I decided to dedicate some of my recent private software projects to the public and uploaded those projects. Sometime a bit dusty but perhaps still worth a look. I uploaded preferably stuff that runs in your browser, but some Apps need to be installed.
